 "use client"; //to make use of onClick event
...
//session variable telling us whether or not a user is logged in or not
//if logged in session then show trips and globe, if !session then show log in button
// empty <> </> needed because siblings 
    ...
    <nav className="bg-white shadow-md py-4 border-b border-gray-200">
      <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
        <Link href="/" className="flex items-center">
          <Image src="/Icon.png" alt="logo" height={70} width={70} />
          <span className="text-2xl font-bold text-gray-800">Planthrop</span>
        </Link>
